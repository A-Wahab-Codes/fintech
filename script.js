(self.$R = self.$R || {})["tsr"] = [];
            self.$_TSR = {
                ...
                c() {
                    this.hydrated && this.streamEnded && (delete self.$_TSR,
                    delete self.$R.tsr)
                },
                p(e) {
            ...
            $_TSR.router = ($R => $R[0] = {
                manifest: $R[1] = {
                    routes: $R[2] = {
                        __root__: $R[3] = {
                            preloads: $R[4] = ["/assets/index-DhGEKqX8.js"],
                            assets: $R[5] = [$R[6] = {
                                tag: "script",
                                attrs: $R[7] = {
                                    type: "module",
                                ...
                                children: "import(\"/assets/index-DhGEKqX8.js\")"
                            }]
                        },
                        "/": $R[8] = {
                            preloads: $R[9] = ["/assets/index-DH5hX6Fd.js", "/assets/SiteLayout-BnfnrTra.js", "/assets/chevron-down-Ca910qj0.js", "/assets/smartphone-HKU6hOOc.js"]
                        }
                    }
                },
                matches: $R[10] = [$R[11] = {
